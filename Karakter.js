export const characters = [
  ...
  {
    nama: "ARCHER",
    ability: "Can help capture opponent’s Leader from two spaces away.",
  ...
  {
    nama: "ASSASSIN",
    ability: "Captures the opponent’s Leader when adjacent.",
  ...
  {
    nama: "JAILER",
    ability: "Adjacent enemies with active ability cannot use ability.",
  ...
  {
    nama: "VIZIER",
    ability: "Your Leader may move one additional space.",
  ...
  {
    nama: "NEMESIS",
    ability: "Must move 2 spaces after enemy Leader moves.",
